...
var Calculator = (function (_super) {
    ...
    function Calculator(props) {
        ...
        _this.calculatorStore = new calculator_store_1.CalculatorStore();
        return _this;
    }
    ...
    Calculator.prototype.inputButton = function (digit) {
        var _this = this;
        return React.createElement("button", { className: "adder-button adder-button-digit", key: digit, onClick: function () { return _this.input(digit); } },
            digit,
            "q");
    };
